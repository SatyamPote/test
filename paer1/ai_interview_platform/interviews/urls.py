...
urlpatterns = [
    # Page to list all interviews, grouped by company
    path('', views.interview_list, name='interview_list'),

    # The actual interview page where the user interacts with the AI
    path('interview/<slug:slug>/', views.interview_detail, name='interview_detail'),

    # API endpoints to communicate with the Gradio backend
    path('api/start_interview/', views.start_interview_api, name='start_interview_api'),
    path('api/handle_response/', views.handle_response_api, name='handle_response_api'),
    path('api/end_interview/', views.end_interview_api, name='end_interview_api'),
]
